...
export default function OrgsCreateNew(userOrgs: any, user: any) {

  console.log('userOrgs ', userOrgs.userOrgs);
      ...
      <div className="bg-white sm:py-24">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
            ...
            {userOrgs?.userOrgs?.length > 0 && <p className="mx-auto mt-12 max-w-xl text-center text-lg leading-8 text-gray-300">
              <a href="/api/auth/login">or choose an organisation you already have access to</a>
            </p>}
